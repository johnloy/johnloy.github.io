  ...
  return html`
    <header class="masthead">
      ...
      <p class="resume-links">
        <a class="resume-link" href="/resume.pdf">${Icon('download')}Download PDF</a>
        <a class="resume-link" href="/resume.json">${jsonIcon}Resume.json</a>
      </p>
    </header>
  `
}
